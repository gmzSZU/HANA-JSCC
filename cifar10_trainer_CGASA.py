...
model = network.HANA_JSCC(num_antenna_tx, num_antenna_rx).to(device)

ckp_path = "./results/CIFAR10_MIMO_16x16_SwinJSCC_wSA_Imp.pth"
...
with open(filename, "w") as f:
    ...
    for epoch in range(total_epoch):
        ...
        for imgs, _ in tqdm(train_loader):
            ...
            res_recovery = model(imgs, train_snr, train_H, train_H_delta)
            # res_recovery = model.aligned_forward(imgs, train_snr, train_H)
        ...
        with torch.no_grad():
            ...
            for imgs, _ in tqdm(val_loader):
                ...
                res_recovery = model(imgs, val_snr, val_H, val_H_delta)
